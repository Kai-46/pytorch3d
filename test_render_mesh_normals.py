...
# os.system('wget https://raw.githubusercontent.com/facebookresearch/pytorch3d/main/docs/tutorials/utils/plot_image_grid.py')
...
plt.savefig('./debug_rendering_normal.png')
plt.axis("off")
...
plt.figure(figsize=(10, 10))
plt.imshow(images[0, ..., :3].cpu().numpy())
plt.savefig('./debug_rendering_rgb.png')
plt.axis("off")
